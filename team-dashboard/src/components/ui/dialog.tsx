...
function DialogPortal({ children, ...props }: { children: ReactNode }) {
  return (
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        className={cn(
          "data-[ending-style]:fade-out-0 data-[open]:fade-in-0 data-[ending-style]:zoom-out-95 data-[open]:zoom-in-95 fixed top-[50%] left-[50%] z-50 grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-lg border bg-background p-6 shadow-lg outline-none duration-200 data-[ending-style]:animate-out data-[open]:animate-in sm:max-w-lg",
          className,
        )}
